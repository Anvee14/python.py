...
#Fetching the data
X = np.load('C:/Users/anvee/my_git_projects/Python/digit_recognition/image.npz')['arr_0']
y = pd.read_csv("C:/Users/anvee/my_git_projects/Python/digit_recognition/labels.csv")["labels"]
